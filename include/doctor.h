 ...
 * [新增架构逻辑]：完美适配 120 急救绿色通道，若队列号为 1 (Score 999)
 * 则在医生大屏端触发全局红色高亮警告！
 */
...
/**
 * @brief 呼叫下一位患者就诊
 * 【核心逻辑】：强制优先呼叫 RECORD_EMERGENCY (急诊)
 * 类型患者，实现急救绿色通道绝对优先权。
 ...
 * [新增架构逻辑]：内置【四级手术权限防越级拦截引擎】，若主刀医生的
 * privilege_level 小于该手术国家卫健委要求的等级，强制中止排期！
 */
 ...
 * @brief 住院患者 ICU 重症流转
 * 【床位熔断机制】：当 ICU
 * 床位耗尽时，拒绝死板报错，而是拉响红色行政告警，提示管理端扩容临时床位或执行病房降级改造！
 */
